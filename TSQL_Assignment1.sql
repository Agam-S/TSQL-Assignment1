...
BEGIN
    SELECT @pAMT = SALES_YTD FROM CUSTOMER WHERE CUSTID = @pCUSTID;
    BEGIN TRY
        IF @pAMT < -999.99 OR @pAMT > 999.99
            THROW 50080, 'Amount out of range', 1
    
        UPDATE CUSTOMER SET @pAMT = SALES_YTD  WHERE CUSTID = @pCUSTID;
    END TRY
    BEGIN CATCH
         if ERROR_NUMBER() = 2627
...
EXEC UPD_CUST_SALESYTD @pCUSTID = 998, @pAMT = 69;
